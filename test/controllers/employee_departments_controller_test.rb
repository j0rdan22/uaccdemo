...
class EmployeeDepartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employee_department" do
    assert_difference('EmployeeDepartment.count') do
      post employee_departments_url, params: { employee_department: { department_id: @employee_department.department_id, employee_id: @employee_department.employee_id } }
    end
  ...
  test "should update employee_department" do
    patch employee_department_url(@employee_department), params: { employee_department: { department_id: @employee_department.department_id, employee_id: @employee_department.employee_id } }
