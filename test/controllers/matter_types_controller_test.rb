...
class MatterTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create matter_type" do
    assert_difference('MatterType.count') do
      post matter_types_url, params: { matter_type: { type_description: @matter_type.type_description } }
    end
  ...
  test "should update matter_type" do
    patch matter_type_url(@matter_type), params: { matter_type: { type_description: @matter_type.type_description } }
